...
public class MapsPO extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_po);
...
//                             Toast.makeText(getApplicationContext(), currentLocation.getLatitude() + "" + currentLocation.getLongitude(), Toast.LENGTH_SHORT).show();
                    ...
                    supportMapFragment.getMapAsync(MapsPO.this);
                }
            }
        });
    }
...
//                .fillColor(0x30ff0000));
        ...
        googleMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Intent i = new Intent(MapsPO.this, Operator_PO.class);
